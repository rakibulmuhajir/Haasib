  ...
  <Card class="pt-0">
    ...
    <CardContent class="px-2 pt-4 sm:px-6 sm:pt-6 pb-4">
      <ChartContainer :config="chartConfig" class="aspect-auto h-[250px] w-full" :cursor="false">
        ...
        <div class="h-[250px] w-full bg-gradient-to-r from-primary/10 to-primary/5 rounded-lg flex items-center justify-center border border-dashed border-primary/20">
          <div class="text-center">
            <div class="text-lg font-semibold text-muted-foreground mb-2">Revenue Analytics Chart</div>
            <div class="text-sm text-muted-foreground">Chart visualization will appear here</div>
            <div class="text-xs text-muted-foreground mt-2">Time range: {{ timeRange }}</div>
          </div>
        </div>
        <ChartLegendContent />
      </ChartContainer>
