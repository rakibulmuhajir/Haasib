...
const startEdit = (vendor: any) => {
  ...
  form.infant_retail_amount = String(vendor.infant_retail_amount ?? vendor.adult_retail_amount ?? 0)
  form.infant_cost_amount = String(vendor.infant_cost_amount ?? vendor.adult_cost_amount ?? 0)
...
const payload = (data: any) => ({
  ...
  infant_retail_amount: Number(data.infant_retail_amount || data.adult_retail_amount || 0),
  infant_cost_amount: Number(data.infant_cost_amount || data.adult_cost_amount || 0),
})
    ...
    <div class="grid gap-6 lg:grid-cols-[520px_minmax(0,1fr)]">
      <Card>
        ...
        <CardContent>
          <form class="space-y-4" @submit.prevent="submit">
            ...
            <div class="space-y-3 rounded-md border p-3">
              <div class="font-medium">Infant Visa Rate</div>
              <div class="grid gap-3 md:grid-cols-2">
                <div class="space-y-2"><Label>Retail</Label><Input v-model="form.infant_retail_amount" type="number" min="0" step="0.01" /></div>
                <div class="space-y-2"><Label>Cost</Label><Input v-model="form.infant_cost_amount" type="number" min="0" step="0.01" /></div>
              </div>
            </div>
      ...
      <Card>
        ...
        <CardContent class="space-y-3">
          ...
          <div v-for="vendor in vendors.data" :key="vendor.id" class="grid gap-3 rounded-md border p-3 xl:grid-cols-[1fr_150px_150px_150px_80px]">
            <div>
            ...
            <div>
              ...
              <div><MoneyText :amount="vendor.infant_retail_amount" :currency="company.base_currency" /></div>
              <div class="text-xs text-muted-foreground">Cost <MoneyText :amount="vendor.infant_cost_amount" :currency="company.base_currency" /></div>
            </div>
            ...
            <div class="text-right xl:col-span-5">
