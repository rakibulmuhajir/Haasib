...
class UpdateTransportPackageRequest extends UmrahFormRequest
{
    ...
    {
        return [
            'name' => ['required', 'string', 'max:150', $this->uniqueForCompany(TransportPackage::class, 'name', 'This journey package already exists.', (string) $this->route('package'))],
