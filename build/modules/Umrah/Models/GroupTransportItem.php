...
class GroupTransportItem extends Model
{
    ...
    protected $fillable = [
        'company_id', 'visa_group_id', 'transport_fare_id', 'transport_service_id', 'transport_sector_id',
    ...
    protected $casts = [
        'company_id' => 'string', 'visa_group_id' => 'string', 'transport_fare_id' => 'string',
    ...
    public function group(): BelongsTo { return $this->belongsTo(VisaGroup::class, 'visa_group_id'); }
    public function fare(): BelongsTo { return $this->belongsTo(TransportFare::class, 'transport_fare_id')->withTrashed(); }
    ...
    public function driver(): BelongsTo { return $this->belongsTo(Driver::class)->withTrashed(); }
}
