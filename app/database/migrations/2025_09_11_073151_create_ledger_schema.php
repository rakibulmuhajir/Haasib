...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if (!Schema::hasTable('acct.ledger_accounts')) {
        ...
        if (!Schema::hasTable('acct.journal_lines')) {
        ...
        $constraintExists = DB::select("
            ...
            WHERE table_schema = 'acct'
            AND table_name = 'ledger_accounts'
            AND constraint_name = 'ledger_accounts_parent_id_foreign'
        ")[0]->count > 0;
    ...
    public function down(): void
    {
        ...
        DB::statement('ALTER TABLE acct.ledger_accounts DROP CONSTRAINT IF EXISTS ledger_accounts_parent_id_foreign');
