...
const breadcrumbs: BreadcrumbItem[] = [
  ...
  { title: 'New Customer', href: `/${props.company.slug}/customers/create` },
]
...
const handleSubmit = () => {
  form
    ...
    .post(`/${props.company.slug}/customers`, {
      preserveScroll: true,
      onSuccess: () => {
  ...
  >
    <div class="mx-auto max-w-xl">
      <Card class="border-rule-default bg-surface-raised" variant="form">
        <CardHeader>
          <CardTitle class="text-text-primary">Customer Details</CardTitle>
          ...
          <form class="space-y-5" @submit.prevent="handleSubmit">
            ...
            <div class="flex justify-end gap-3 pt-4 border-t border-rule-subtle">
              <Button
                type="button"
                variant="outline"
                @click="$inertia.visit(`/${props.company.slug}/customers`)"
              >
                Cancel
              </Button>
