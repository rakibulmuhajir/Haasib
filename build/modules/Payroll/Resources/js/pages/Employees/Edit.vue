...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: 'Edit',
        href: `/${props.company.slug}/employees/${props.employee.id}/edit`,
    },
];
    ...
    >
        <template #actions>
            <Button
                variant="outline"
                @click="
                    $inertia.get(`/${company.slug}/employees/${employee.id}`)
                "
            >
        ...
        <form @submit.prevent="submit" class="max-w-4xl space-y-6">
            ...
            <Card>
                ...
                <CardContent class="space-y-4">
                    ...
                    <div
                        ...
                        class="grid grid-cols-1 gap-4 rounded-lg bg-destructive/10 p-4 md:grid-cols-2"
                    >
                        <div class="space-y-2">
            ...
            <div class="flex justify-end gap-4">
                <Button
                    ...
                    @click="
                        $inertia.get(
                            `/${company.slug}/employees/${employee.id}`,
                        )
                    "
                >
                    Cancel
