...
final class Permissions
{
    ...
    public static function getRolePresets(): array
    {
        return [
            ...
            'company_admin' => [
                ...
                ...array_merge(
                    self::getAllByModule()['acct.customers'],
                    self::getAllByModule()['acct.invoices'],
                    self::getAllByModule()['acct.payments'],
                    self::getAllByModule()['acct.allocations'],
                    self::getAllByModule()['ledger.entries'],
                    self::getAllByModule()['ledger.accounts'],
                    self::getAllByModule()['reporting.dashboard'],
                    self::getAllByModule()['reporting.reports'],
                    self::getAllByModule()['commands']
                ),
    ...
    /**
     * Check if permission follows naming convention.
     */
    public static function isValidPermissionName(string $permission): bool
    {
        // Pattern: module.resource.action or system.action
        return preg_match('/^[a-z]+(\.[a-z_]+)*\.[a-z_]+$/', $permission) === 1;
    }
}