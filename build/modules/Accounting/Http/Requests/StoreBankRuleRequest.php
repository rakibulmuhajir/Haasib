...
class StoreBankRuleRequest extends BaseFormRequest
{
    public function authorize(): bool
    {
        return $this->hasCompanyPermission(Permissions::BANK_RULE_CREATE)
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'bank_account_id' => ['nullable', 'uuid', Rule::exists(BankAccount::class, 'id')],
            ...
            'actions.set_gl_account_id' => ['nullable', 'uuid', Rule::exists(Account::class, 'id')],
