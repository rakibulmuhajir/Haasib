...
class StoreVisaGroupRequest extends UmrahFormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'transport_service_id' => ['required', 'uuid', $this->existsForCompany(TransportService::class, 'Selected transport service was not found.')],
            ...
            'transport_quantity' => ['required', 'integer', 'min:1', 'max:100'],
