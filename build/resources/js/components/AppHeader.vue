...
<template>
    <div>
                        ...
                        <DropdownMenuTrigger :as-child="true">
                            ...
                            >
                                ...
                                >
                                    ...
                                    />
                                    <AvatarFallback
                                        class="rounded-lg bg-surface-sunken font-semibold text-text-primary"
                                    >
        ...
        >
            <div
                class="mx-auto flex h-12 w-full items-center justify-start px-4 text-text-secondary md:max-w-7xl"
            >
