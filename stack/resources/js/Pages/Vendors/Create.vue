...
<template>
    <LayoutShell>
        ...
        <UniversalPageHeader
            ...
            description="Add a new supplier or vendor to your system"
            subDescription="Enter vendor details and contact information"
        />
        ...
        <div class="max-w-4xl mx-auto">
            <div class="bg-white dark:bg-gray-900 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                ...
                <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Basic information about the vendor</p>
                </div>
                    ...
                    <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                        <div class="flex items-center justify-between mb-4">
                            <div>
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400">Add contact persons for this vendor</p>
                            </div>
                            <Button
                                type="button"
                                @click="addContact"
