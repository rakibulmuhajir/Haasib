...
const resolvePage = async (name: string) => {
  ...
  // Prefer the full name first, then the accounting/ stripped variant.
  addCandidate(normalized)
  addCandidate(stripped)

  // Leaf folder shortcut (accounts/Index -> accounts/Index, etc)
  ...
  // Fallback: if the page name is module-prefixed (e.g. `inventory/categories/Create`),
  // also try without the module prefix to tolerate resolver/manifest path differences.
