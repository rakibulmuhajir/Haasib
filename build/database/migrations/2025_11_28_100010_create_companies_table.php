...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // Allow common industries case-insensitively (e.g., 'Technology' or 'technology')
        DB::statement("
            ALTER TABLE auth.companies
            ADD CONSTRAINT companies_industry_allowed
            CHECK (
                industry IS NULL
                OR lower(industry) IN ('ai','education','energy','healthcare','manufacturing','media','medical','research','retail','services','technology','transportation')
            )
        ");
