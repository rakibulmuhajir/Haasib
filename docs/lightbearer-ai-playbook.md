...
- **Frontend**: Place components/pages in the correct module folder, enforce permission-driven rendering, build UI with PrimeVue v4 components, respect light/dark theme tokens, and use FontAwesome 5 icon set; add i18n-ready labels/placeholders.
...
- **Manual QA**
  ...
  - Verify UI labels appear in all supported locales, light/dark themes behave correctly, and permission-based controls hide/show as expected.
