...
class UpdateTaxSettingsRequest extends BaseFormRequest
{
    ...
    public function rules(): array
    {
        return [
            'tax_enabled' => ['boolean'],
            'default_jurisdiction_id' => ['nullable', 'uuid', Rule::exists(Jurisdiction::class, 'id')],
            'default_sales_tax_rate_id' => ['nullable', 'uuid', Rule::exists(TaxRate::class, 'id')],
            'default_purchase_tax_rate_id' => ['nullable', 'uuid', Rule::exists(TaxRate::class, 'id')],
