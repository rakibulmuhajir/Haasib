...
return [
    ...
    'collectors' => [
        // This collector will find all classes with the #[TypeScript] attribute
        // or a /** @typescript */ docblock.
        Spatie\TypeScriptTransformer\Collectors\DefaultCollector::class,

        // This collector will find all native PHP enums.
        Spatie\TypeScriptTransformer\Collectors\EnumCollector::class,

        // EITHER: Use our custom collector that finds models in app/Models
        // and looks for a corresponding DTO in app/Data (e.g., User -> UserData).
        App\TypeScript\Collectors\ModelDtoCollector::class,

        // OR: If you use spatie/laravel-data, you can use its dedicated collector.
        // It will find all classes that extend Spatie\LaravelData\Data.
    ...
    'transformers' => [
        ...
        Spatie\LaravelTypeScriptTransformer\Transformers\ModelTransformer::class,
        Spatie\TypeScriptTransformer\Transformers\EnumTransformer::class,
        Spatie\TypeScriptTransformer\Transformers\SpatieEnumTransformer::class,
        Spatie\LaravelTypeScriptTransformer\Transformers\DtoTransformer::class,

        // If using spatie/laravel-data, you should use its transformer.
