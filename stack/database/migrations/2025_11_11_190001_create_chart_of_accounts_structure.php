...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::table('acct.account_classes')->insert([
            ['id' => DB::raw('generate_uuid()'), 'name' => 'Assets', 'normal_balance' => 'debit', 'type' => 'balance_sheet', 'order' => 1, 'is_active' => true],
            ['id' => DB::raw('generate_uuid()'), 'name' => 'Liabilities', 'normal_balance' => 'credit', 'type' => 'balance_sheet', 'order' => 2, 'is_active' => true],
            ['id' => DB::raw('generate_uuid()'), 'name' => 'Equity', 'normal_balance' => 'credit', 'type' => 'balance_sheet', 'order' => 3, 'is_active' => true],
            ['id' => DB::raw('generate_uuid()'), 'name' => 'Revenue', 'normal_balance' => 'credit', 'type' => 'income_statement', 'order' => 4, 'is_active' => true],
            ['id' => DB::raw('generate_uuid()'), 'name' => 'Expenses', 'normal_balance' => 'debit', 'type' => 'income_statement', 'order' => 5, 'is_active' => true],
            ['id' => DB::raw('generate_uuid()'), 'name' => 'Cost of Goods Sold', 'normal_balance' => 'debit', 'type' => 'income_statement', 'order' => 6, 'is_active' => true],
            ['id' => DB::raw('generate_uuid()'), 'name' => 'Other Income', 'normal_balance' => 'credit', 'type' => 'income_statement', 'order' => 7, 'is_active' => true],
            ['id' => DB::raw('generate_uuid()'), 'name' => 'Other Expenses', 'normal_balance' => 'debit', 'type' => 'income_statement', 'order' => 8, 'is_active' => true],
        ]);
