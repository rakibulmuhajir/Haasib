...
const breadcrumbs = computed<BreadcrumbItem[]>(() => [
  ...
  { title: 'Add Partner', href: `/${companySlug.value}/partners/create` },
])
...
const submit = () => {
  form.post(`/${companySlug.value}/partners`, {
    preserveScroll: true,
  })
}
...
<template>
  ...
  <PageShell
    title="Add Partner"
    description="Add a new business partner with their capital contribution and profit sharing details."
    :icon="UsersRound"
            ...
            <div class="space-y-2">
              ...
              <div class="relative">
                ...
                <Input
                  ...
                  v-model.number="form.initial_investment"
                  type="number"
                  min="0"
                  step="0.01"
                  placeholder="0"
