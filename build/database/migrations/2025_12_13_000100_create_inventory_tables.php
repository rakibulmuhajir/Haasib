...
return new class extends Migration
{
    ...
    {
        // Test schema cleanup belongs in the test harness. A forward migration must never
        // delete an existing inventory or fuel schema to recover from stale test state.
